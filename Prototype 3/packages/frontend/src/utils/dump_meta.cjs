...
async function run() {
  ...
  console.log("Fetching attendance metadata...");
  ...
  console.log("attMeta.semlist JSON:");
  console.log(JSON.stringify(metaRes.response.semlist, null, 2));

  console.log("\nattMeta.headerlist JSON:");
  console.log(JSON.stringify(metaRes.response.headerlist, null, 2));
}
